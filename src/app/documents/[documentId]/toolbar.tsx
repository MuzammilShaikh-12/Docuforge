...
const FontSizeButton = () => {
    ...
    return (
        <div className="flex items-center gap-x-0.5">
            <button className="h-7 w-7 shrink-0 flex flex-col items-center justify-center rounded-sm hover:bg-neutral-200/80"
            onClick={decrement} >
            ...
            {isEditing ? (
                ...
                className="h-7 w-7 shrink-0 rounded-sm border border-neutral-200/80 bg-transparent focis:outline-none focus:ring-0 text-sm"
                />
            ) : (
                <button
                onClick={() => {
                ...
                className="h-7 w-7 text-sm rounded-sm border border-neutral-400 bg-transparent cursor-text">
                    {currentFontSize}
                </button>
            )
            }
